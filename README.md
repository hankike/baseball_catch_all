...
With bat tracking data from Baseball Savant, I want to construct a reaction time statistic. We are given average bat speed as well as average swing length by baseball savant. Using velocity conversion along with velocity and acceleration equations, we can convert these values into a time value, giving us the amount of time it on average takes for a batter to make contact with the ball.
